    ...
    <footer className={cn("bg-[#111] text-white py-[50px]")}>
      ...
      >
        <div className={cn("footer-box flex flex-col gap-[12px]")}>
          <h3 className={cn("text-lg font-bold mb-[15px]")}>
            {t("customerCare")}
          </h3>
          <Link
            to="/contact"
        ...
        <div className={cn("footer-box flex flex-col gap-[12px]")}>
          <h3 className={cn("text-lg font-bold mb-[15px]")}>{t("followUs")}</h3>
          <div
          ...
          >
            {siteSettings.socialLinks?.facebook && (
              ...
              >
                <i
                  className={cn(
                    "fa-brands fa-facebook hover:text-red-500 transition-colors",
                  )}
                ></i>
              </a>
            )}
            {siteSettings.socialLinks?.instagram && (
              ...
              >
                <i
                  className={cn(
                    "fa-brands fa-instagram hover:text-red-500 transition-colors",
                  )}
                ></i>
              </a>
            )}
            {siteSettings.socialLinks?.tiktok && (
              ...
              >
                <i
                  className={cn(
                    "fa-brands fa-tiktok hover:text-red-500 transition-colors",
                  )}
                ></i>
              </a>
            )}
            {siteSettings.socialLinks?.youtube && (
              ...
              >
                <i
                  className={cn(
                    "fa-brands fa-youtube hover:text-red-500 transition-colors",
                  )}
                ></i>
              </a>
            )}
            {(!siteSettings.socialLinks ||
              ...
              <>
                <i
                  className={cn(
                    "fa-brands fa-facebook cursor-pointer hover:text-red-500 transition-colors",
                  )}
                ></i>
                <i
                  className={cn(
                    "fa-brands fa-instagram cursor-pointer hover:text-red-500 transition-colors",
                  )}
                ></i>
                <i
                  className={cn(
                    "fa-brands fa-tiktok cursor-pointer hover:text-red-500 transition-colors",
                  )}
                ></i>
                <i
                  className={cn(
                    "fa-brands fa-youtube cursor-pointer hover:text-red-500 transition-colors",
                  )}
                ></i>
              </>
            )}
